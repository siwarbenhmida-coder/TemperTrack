...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->num_rows > 0) {
        ...
        if (password_verify($password, $hashed_password)) {
            ...
            $_SESSION['role'] = $role;
            header("Location: get_data.php"); // Redirection après connexion
            exit();
        } else {
